...
/* MOD-990216 [HD]: The 'hashtable' local var are conflicting with the hashtable type
*	when this file is included from C++ code (even with extern "C" comments).
void    qh_hashridge (setT *hashtable, int hashsize, ridgeT *ridge, vertexT *oldvertex);
*/
void    qh_hashridge (setT *, int, ridgeT *, vertexT *);
ridgeT *qh_hashridge_find (setT *, int, ridgeT *, vertexT *, vertexT *, int *);
